...
default_list <- tibble(
  ...
  Min = map(list('70', '259', '805', '245', '1330', '0.085799', '910', '0.665', '13.3', '30.1', '476', '0.06531', '0.25', paste(NPLDS*0.8),  '0.77', '0.28', '5.6', '24.5'), function(x) if(is.character(x)){as.numeric(x)}else{x}),
  Max = map(list('200', '481', '1495', '455', '2470', '0.159341', '1690', '1.235', '24.7', '55.9', '884', '0.12129', '0.65', paste(NPLDS*0.8), '1.43', '0.52', '10.4', '45.5'), function(x) if(is.character(x)){as.numeric(x)}else{x}),
