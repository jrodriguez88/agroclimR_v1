...
tidy_to_write_crop <- function(param_data, model = "oryza", values = "Base", export_default = T){
  ...
  default_list <- tibble(
    ...
    Min = map(list('0.0004592', '0.00053032', '0.0004767', '0.0016457', '0.00595', '0.0028', '0.00315', 
                   tibble(DVS = c(0.00,	0.16,	0.33,	0.65,	0.79,	2.10,	2.50),
                   ...
                   '1.015', '982.8', '0.28', '14.7', '25.55'), function(x) if(is.character(x)){as.numeric(x)}else{x}),
    Max = map(list('0.0008528', '0.00098488', '0.0008853', '0.0030563', '0.01105', '0.0052', '0.00585', 
                   tibble(DVS = c(0.00,	0.16,	0.33,	0.65,	0.79,	2.10,	2.50),
                   ...
                   '1.885', '1825.2', '0.52', '27.3', '47.45'), function(x) if(is.character(x)){as.numeric(x)}else{x}),
